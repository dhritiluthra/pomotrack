...
export default function PomoInfo() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-4 text-gray-700 font-varela mt-8">
      ...
      <p className=" text-xl font-semibold">What is Pomotrack?</p>
      ...
      <p className=" text-xl font-semibold">What is Pomodoro Technique?</p>
      <p className="text-sm text-gray-600">
      ...
      <ol type="1" className=" text-sm text-gray-600">
      ...
      <p className="text-xl font-semibold">What is Pomofocus?</p>
    </div>
  );
}
